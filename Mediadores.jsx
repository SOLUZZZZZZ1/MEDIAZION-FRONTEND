      ...
      >
        ...
        <section className="sr-card" style={{ background: "rgba(255,255,255,0.98)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(1, minmax(0, 1fr))", gap: 12 }}>
            ...
            <div className="p-4 rounded-xl" style={{ background: "rgba(237,248,255,0.95)", border: "1px solid #b6e0ff" }}>
              <h3 style={{ margin: 0, fontWeight: 800, fontSize: 18 }}>🧭 Plan Profesional · 7 días gratis</h3>
              <ul className="sr-p" style={{ marginLeft: 18, listStyle: "disc" }}>
                <li>Panel Profesional con expedientes.</li>
                <li>Asistente de IA para actas y resúmenes.</li>
                <li>Subida de documentos y CV para validación.</li>
                <li>Visibilidad en el Directorio oficial.</li>
                <li>Alertas por email cuando se te asigne un caso.</li>
              </ul>
              <p className="sr-p" style={{ margin: 0 }}>
                El trial se activa en el checkout tras confirmar tu alta (estado <strong>approved</strong>).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="sr-card mt-6" style={{ background: "rgba(255,255,255,0.98)" }}>
          ...
          <p className="sr-p">Consulta el listado público de profesionales validados por MEDIAZION.</p>
          <div><a className="sr-btn-secondary" href="/directorio">Ver directorio</a></div>
        </section>
      </div>
    </main>
  );
