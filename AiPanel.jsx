// src/pages/AiPanel.jsx — Asistente IA Profesional (chat + documento + exportar DOCX)
...
export default function AiPanel() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "¡Hola! Soy tu asistente de mediación. Escribe en el cuadro de la derecha (o debajo en móvil) o pulsa un preset para generar al instante.",
    },
  ]);
  ...
  async function handleFilePick(e) {
    ...
    try {
      ...
      // backend devuelve {ok:true, filename, url}
  ...
  async function handleExportDocx() {
    try {
      ...
      // Si no hay summary, usamos el último mensaje de la IA (para exportar cualquier cosa)
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 mb-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              onClick={() =>
                (window.location.hash = "#/panel-mediador/perfil?tab=seguridad")
              }
            >
              Cambiar contraseña
            </button>
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                window.location.hash = "#/panel-mediador";
              }}
            >
              Volver al panel
            </a>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/30">
            <div className="bg-white rounded-2xl shadow-xl p-6 w-[95%] max-w-2xl">
              ...
              <p className="sr-small text-zinc-600 mt-1">
                Si dejas los campos vacíos, se exporta el último texto de la IA.
              </p>
