...
export default function MediadoresDirectorio() {
  ...
  return (
    ...
    >
      ...
      <p className="sr-p mb-4">Profesionales aprobados por MEDIAZION.</p>
          ...
          <article key={m.id} className="sr-card" style={{background:"rgba(255,255,255,0.96)"}}>
            <div style={{display:"flex", gap:12}}>
              ...
              <div>
                ...
                <p className="sr-p" style={{margin:0}}>{Array.isArray(m.especialidad)? m.especialidad.join(" · ") : (m.especialidad || "")}</p>
